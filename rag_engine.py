...
Answer the user's questions based only on the meeting transcript provided below.
...
def load_rag_chain():
    ...
    prompt= ChatPromptTemplate([
            (
                "system",
                """you are an expert meeting assistent.
Answer the user's questions based only on the meeting transcript provided below.
If the answer is not found in the context,9 say:
"I could not find this information in the meeting transcript."
